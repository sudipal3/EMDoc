...
const sectionOrder = [
    'time', 'indication', 'views', 'findings', 'interpretation'
];
...
function handleTimeButtonClick(button) {
    ...
    // Add the timestamped time text, ensuring no duplicates
...
function addMainHeader() {
    ...
    if (!outputArea.querySelector('h2')) {
        outputArea.insertAdjacentHTML('afterbegin', `<h2>POCUS: Obstetric</h2><br>`);
    }
}
