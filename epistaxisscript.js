// Define the order of sections for Epistaxis
const sectionOrder = [
    'consent', 'locationType', 'interventions', 'outcome', 'complications', 'provider'
];
...
function addMainHeader() {
    ...
    if (!outputArea.querySelector('h2')) {
        outputArea.insertAdjacentHTML('afterbegin', `<h2>Procedure Note: Epistaxis Management</h2><br>`);
    }
}
